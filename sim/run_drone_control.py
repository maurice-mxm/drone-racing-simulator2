...
from baselines.ppo.ppo2_test import test_model
from baselines.envs import vec_env_wrapper as wrapper
import baselines.common.util as U
#
#from flightgym import QuadrotorEnv_v1
from quadrotor_env import VecEnv

#from Vec_env_test import VecEnv
...
def main():
    ...
    env = wrapper.FlightEnvVec(VecEnv)
    
    #env = wrapper.FlightEnvVec(main)
